(function() {
    ...
    MESSAGES.push({
      delay: 0,
      text: "**Incoming Transmission from (Kero)**"
    });
  
    MESSAGES.push({
      delay: 1500,
      text: "I have fallen so deep for you.."
    });
  
    MESSAGES.push({
      delay: 2500,
      text: "You wrap my heart in leather"
    });
  
    MESSAGES.push({
      delay: 3600,
      text: "My perception of reality has changed.."
    });
  
    MESSAGES.push({
      delay: 5200,
      text: "Now all I want is for us to be together"
    });
